...
| `Mjlab-PetMotion-Flat-MicroDuck` | flat | Calm approach/retreat plus commandable nuzzle lean and excitement bob |
...
| XML | Used by |
|---|---|
| `robot_walk.xml` | Velocity and PetMotion (stripped trunk/head contacts — falling is cheap) |
